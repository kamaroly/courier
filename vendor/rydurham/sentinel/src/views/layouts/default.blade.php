		...
		<div class="navbar navbar-inverse navbar-fixed-top">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="{{ URL::route('home') }}">Urugendo.rw</a>
	        </div>
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
				@if (Sentry::check() && Sentry::getUser()->hasAccess('admin'))
					...
					<li {{ (Request::is('*admin*reservat*') ? 'class="active"' : '') }}><a href="{{Url()}}/admin/reservations">reservations</a>
					</li>
					<li {{ (Request::is('admin/route') ? 'class="active"' : '') }}><a href="{{Url()}}/admin/routes">Routes</a>
					</li>
					<li {{ (Request::is('admin/courriers') ? 'class="active"' : '') }}>
						<a href="{{route('admin.courriers.index')}}">Courriers</a>
					</li>
					<li {{ (Request::is('admin/cities') ? 'class="active"' : '') }}>
						<a href="{{Url()}}/admin/cities">Cities</a>
					</li>
					<li {{ (Request::is('admin/route') ? 'class="active"' : '') }}>
						<a href="{{Url()}}/admin/areas">Area</a>
					</li>

					<li {{ (Request::is('admin/courriers/routes') ? 'class="active"' : '') }}>
						<a href="{{Url()}}/admin/courriers/routes">C Routes</a>
					</li>
					

					<li {{ (Request::is('admin/courriers/transporters*') ? 'class="active"' : '') }}>
						<a href="{{route('admin.courriers.transporters.index')}}">transporters</a>
					</li>
